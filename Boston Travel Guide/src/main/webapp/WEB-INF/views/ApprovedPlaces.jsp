...
<script type="text/javascript">
	...
	function deleteData(id) {
		...
		var query = "action=text&id=" + a + "&atitle=" + b
				+ "&message=" + c + "&location=" + d + "&phoneNumber=" + e;
...
<body>
	<form:form action="manage.htm" method="post" commandName="advertisement">
				...
				<table id="myTable" class="myTable1" align="center" border="1" cellpadding="3"
					cellspacing="3">
					...
					<tr>
						<td align="center" style="font-size: 120%;"><b>ID</b></td>
						<td align="center" style="font-size: 120%;"><b>CATEGORY</b></td>
						<td align="center" style="font-size: 120%;"><b>PLACE</b></td>
						<td align="center" style="font-size: 120%;"><b>MESSAGE</b></td>
						<td align="center" style="font-size: 120%;"><b>LOCATION</b></td>
						<td align="center" style="font-size: 120%;"><b>PHONE NUMBER</b>
						<td align="center" style="font-size: 120%;"><b>PHOTO</b>
					</tr>
					<c:forEach var="adv" begin="0" items="${adList}" varStatus="status">
					<c:set var="i" value="${status.index}" />
						<tr>
							<td align="center"><input type="text" id="myTextA${i}" style="font-size: 120%;"
								name='id${i}' value="${adv.category}"/></td>

							<c:forEach var="categ" items="${categories}">
								<c:if test="${adv.category == categ.id}">
									<td align="center"><input type="text" value="${categ.title}" style="font-size: 120%;"/></td>
								</c:if>
							</c:forEach>


							<td align="center"><input type="text" id="myTextB${i}" style="font-size: 120%;"
								name='atitle${i}' value="${adv.title}"/></td>
							<td align="center"><input type="text" id="myTextC${i}" style="font-size: 120%;"
								name='message${i}' value="${adv.message}"/></td>
							<td align="center"><input type="text" id="myTextD${i}" style="font-size: 120%;"
								name='location${i}' value="${adv.location}"/></td>
							<td align="center"><input type="text" id="myTextE${i}" style="font-size: 120%;"
								name='phoneNumber${i}' value="${adv.phoneNumber}"/></td>
							<td align="center"><img height="300" width="300" src="${adv.photoName}" /></td>
							<td align="center"><input type="button" value="Delete" class="button"
								onclick="deleteData('${i}'),deleteRow(this)"></td>
						</tr>
					</c:forEach>
