...
<script type="text/javascript">
	...
	function check(id) {
		...
		xmlHttp.open("POST", "nightclub.htm", true);
...
<body>
	<form action="nightclub.htm" method="post" commandName="advertisement">
		<div align="center">
				...
				<c:if test="${adv.status == 'Approved'}">
					<tr>
						<td align="center"><input type="text" id="myTextA${i}"
							style="font-size: 130%;" name='title${i}' value="${adv.title}" /></td>
						<td align="center"><input type="text" id="myTextB${i}"
							style="font-size: 130%;" value="${adv.message}" /></td>
						<td align="center"><input type="text" id="myTextC${i}"
							style="font-size: 130%;" value="${adv.location}" /></td>
						<td align="center"><input type="text" id="myTextD${i}"
							style="font-size: 130%;" value="${adv.phoneNumber}" /></td>
						...
						<td align="center"><a class="button"
							href="http://www.the-pub.com/thepub/images/menu/drink-menu.pdf">Special
								Drinks</a></td>
						<td align="center"><input type="button" id="Recommend${i}"
							class="button" value="Recommend"
