...
<script type="text/javascript">
	...
	function check(id) {
		...
		xmlHttp.open("POST", "museum.htm", true);
...
<body>
	<form action="museum.htm" method="post" commandName="advertisement">
		
				<div align="center">
					<a href="contents.jsp">Home</a>

						<h2 align="center">
							<font size="6">Museums In Boston</font>
						</h2>
					...
					<c:forEach var="adv" begin="0" items="${advertisement}"
						...
						<tr>
							<td align="center"><input type="text" id="myTextA${i}" style="font-size: 130%;"
								name='title${i}' value="${adv.title}" /></td>
							<td align="center"><input type="text" id="myTextB${i}" style="font-size: 130%;" value="${adv.message}" /></td>
							...
							<td align="center"><a class="button"
								href="mailto:someone@example.com?Subject=Boston%20Travel%20Guide&body=Place:%20${adv.title},%20Message:%20${adv.message},%20Location:%20${adv.location},%20PhoneNumber:%20${adv.phoneNumber}.%20">Send</a></td>
							<td align="center"><a class="button"
								href="http://www.muuseum.ee/uploads/files/g._lewis_the_history_of_museums.pdf">View
									History</a></td>
							<td align="center"><input type="button" id="Recommend${i}" class="button"
								value="Recommend" onclick="check('${i}'),disable('${i}')"></td>
						</tr>
						</c:if>
					</c:forEach>
				</table>
