...
<script type="text/javascript">
	...
	function check(id) {
		...
		xmlHttp.open("POST", "hotel.htm", true);
...
<body>
	<form action="hotel.htm" method="post" commandName="advert">
				...
				<div align="center">
					<a href="contents.jsp">Home</a>
						...
						<h2 align="center">
							<font size="6">Hotels In Boston</font>
						</h2>
					...
					<c:forEach var="adv" begin="0" items="${advertisement}"
						...
						<c:if test="${adv.status == 'Approved'}">
							<tr>
								...
								<td align="center"><a class="button"
									href="http://www.marriott.com/Multimedia/PDF/Hotel_Development/ACHotelsbyMarriottDesignStandardsBrochure.pdf">View
										Rooms</a></td>
								<td align="center"><input type='button' name='button' class="button"
									id='Recommend${i}' value='Recommend'
